...
func TestParseRejectsMalformedSchema(t *testing.T) {
	cases := []struct {
		...
		{"native plugin missing marketplace", "plugins: [example]", "plugins[0]"},
		{"native plugin empty name", "plugins: ['@market']", "plugins[0]"},
		{"native plugin empty marketplace", "plugins: ['example@']", "plugins[0]"},
		{"native plugin extra separator", "plugins: ['example@market@other']", "plugins[0]"},
		{"native plugin path", "plugins: ['../example@market']", "plugins[0]"},
		{"native plugin whitespace", "plugins: ['example @market']", "plugins[0]"},
